...
public class SendEmailService {
	...
	public void sendEmail(String to, String topic,float reg,String motif,String name ,String date,File file) throws MessagingException
	{
		...
		mimeMessageHelper.setFrom("yahiabourguiba1997@gmail.com");
		...
		//mimeMessageHelper.setText(body,true);
          ...
          messageBodyPart.setContent("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                  ...
                  "<p style=\"font-size: 42px; line-height: 1.2; word-break: break-word; text-align: center; font-family: inherit; mso-line-height-alt: 50px; margin: 0;\"><span style=\"font-size: 42px; color: #2a272b;\"><strong> Cher Cleint Mr/Mme " + name + "</strong></span></p>\n" +
                  "</div>\n" +
                  "</div>\n" +
                  "<!--[if mso]></td></tr></table><![endif]-->\n" +
                  ...
                  "<p style=\"line-height: 1.5; word-break: break-word; text-align: center; font-family: inherit; mso-line-height-alt: NaNpx; margin: 0;\"><span style=\"color: #2a272b;\"><span style=\"font-size: 16px;\"><strong>On vous informe que votre Sinistre, envoyée à la date :"+ date +" a été bien " + motif + " avec un Montant de " + reg + ".<br> Merci pour votre Confiance.<br> Vous pouvez visiter ce site pour plus d'informations. </strong></span></span></p>\n" +
